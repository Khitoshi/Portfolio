  ...
  return (
    <div className="bg-[#161B22] border border-[#30363D] rounded-lg p-6">
      <div className="flex items-center mb-4">
        <svg className="w-6 h-6 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        {repositories.map((repo) => (
          ...
          >
            <div className="flex flex-col justify-between mb-2">
              <h3 className="text-lg font-semibold text-blue-400 mb-1 hover:underline">
                {repo.name}
              </h3>
